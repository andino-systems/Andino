...
from andinopy import andinopy_logger, andinoio
...
class terminal:
    ...
    rfid_keyboard_instance: 'rfid_keyboard'

    def __init__(self,
                 andinoio_instance: andinoio.andinoio = None,
                 display_instance: 'display' = None,
                 rfid_keyboard_instance: 'rfid_keyboard' = None):
        """
        ...
        self.rfid_keyboard_instance = rfid_keyboard_instance \
            if rfid_keyboard_instance is not None else rfid_keyboard()
...
class display:
    ...
    def process_message(self, read_buffer: bytearray):
        andinopy_logger.debug(f"Nextion device - received message: {str(read_buffer)}")
